...
public class UpdateDeleteActivity extends AppCompatActivity {
    ...
    private EditText etname, ethobby, etcity, etaddress;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnupdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                databaseHelper.updateUser(userModel.getId(),etname.getText().toString(),ethobby.getText().toString(),etcity.getText().toString(),etaddress.getText().toString());
