package com.example.nuhin13.sqlite;
...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static String DATABASE_NAME = "sql_database";
    ...
    private static final String CREATE_TABLE_USER_CITY = "CREATE TABLE "
            + TABLE_USER_CITY + "(" + KEY_ID + " INTEGER,"+ KEY_CITY + " TEXT," + KEY_ADDRESS + " TEXT );";
    ...
    public void addUser(String name, String hobby, String city, String address) {
       ...
       // db.insert(TABLE_USER, null, values);
        ...
        valuesCity.put(KEY_ADDRESS,address);

        long rowInserted = db.insert(TABLE_USER_CITY, null, valuesCity);
        if(rowInserted != -1)
                ...
                Cursor cCity = db.rawQuery(selectCityQuery, null);
                            ...
                            if (cCity.moveToFirst()) {
                                do {
                                    ...
                                    userModel.setAddress(cCity.getString(cCity.getColumnIndex(KEY_ADDRESS)));
    ...
    public void updateUser(int id, String name, String hobby, String city, String address) {
        SQLiteDatabase db = this.getWritableDatabase();
